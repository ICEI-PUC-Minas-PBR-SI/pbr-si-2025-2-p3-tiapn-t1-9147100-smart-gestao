...
describe('1. Módulo de Autenticação (Legado)', () => {
    ...
    it('deve barrar o cadastro de um usuário com e-mail já existente', async () => {
        ...
        try {
            ...
            console.log('✅ E-mail duplicado barrado com sucesso (Status 409).');
        }
    });
    ...
    it('deve falhar o login com senha incorreta', async () => {
        ...
        try {
            ...
            console.log('✅ Login com senha incorreta falhou como esperado (Status 401).');
        }
    });
